...
const SWIFTPAY_API_KEY = process.env.SWIFTPAY_API_KEY || 'kingdomnanies-key';
...
export default async (req, res) => {
  ...
  try {
    // Parse request body
    let { phoneNumber, amount = 120, email, reference } = req.body;
    ...
    const externalReference = reference || `KINGDOMNANIES-${Date.now()}`;
