...
// Using local images to avoid external dependencies
const kenyaHeroImage = "/assets/kenya-hero-image.jpg";
const caregiverImage = "/assets/caregiver-image.jpg";
const housekeeperImage = "/assets/housekeeper-image.jpg";
const nannyImage = "/assets/caregiver-image.jpg";
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-lg transition-all duration-300 hover:shadow-xl">
          ...
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 font-medium hidden sm:block">Kenya's Trusted Home Care</p>
              </div>
            </div>
        ...
        <div className="absolute -bottom-6 sm:-bottom-8 right-2 sm:right-4 hidden sm:block">
          <div className="bg-gradient-to-r from-green-500 to-green-600 text-white text-xs px-2 sm:px-3 py-1 rounded-full shadow-lg">
            500+ Jobs Available
          </div>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            <div className="text-white">
              ...
              <div className="flex items-center gap-2 mb-6 animate-slide-in-left">
                ...
                <span className="text-kenya-gold font-semibold tracking-wide">🏠 KENYA'S TRUSTED HOME CARE SERVICES</span>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4 animate-fade-in">
                ...
                <StatCard icon={Clock} number="<24hrs" label="Fast Placement" />
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl mb-8 leading-relaxed animate-fade-in">
                ...
                📧 This application was submitted through the Kingdom Nannies website.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-white text-center">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <div>
                ...
                <div className="text-white/80">jobs@kingdomnannies.co.ke</div>
              </div>
            </div>
            <div className="flex items-center justify-center gap-3">
      ...
      <footer className="bg-foreground/95 text-white py-8 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/60 text-sm">
            🇰🇪 Kingdom Nannies - Professional home care services in Kenya.
          </p>
        </div>
      </footer>
    </div>
